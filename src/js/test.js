        ...
        try {
            ...
            if (usersData.length > 0) {
                ...
                usersData.forEach(user => {
                    ...
                    row.innerHTML = `
                        <td><input type="text" name="nombre" class="firstName" value="${user.nombre}"></td>
                        <td><input type="text" name="apellidos" class="lastName" value="${user.apellidos}"></td>
                        <td><input type="email" name="correo" class="email" value="${user.correo}"></td>
                        <td><input type="number" name="edad" class="age" value="${user.edad}"></td>
                        <td><input type="text" name="direccion" class="address" value="${user.direccion}"></td>
                        <td><input type="tel" name="telefono" class="mobile" value="${user.telefono}"></td>
                        <td><button type="button" class="edit-btn form-submit-btn">Editar</button></td>
                    `;
                    tbody.appendChild(row);

                    const editButton = row.querySelector('.edit-btn');
                    editButton.addEventListener('click', () => {
                        // Encuentra los campos de entrada dentro de la fila
                        ...
                        const mobile = row.querySelector('.mobile').value;
                        
                        // Crea un objeto JSON con los valores recopilados
                        const updatedUser = {
                            nombre: firstName,
                            apellidos: lastName,
                            correo: email,
...
//                    <td><input type="text" name="direccion" class="address" value="${user.direccion}"></td>
//                    <td><input type="tel" name="telefono" class="mobile" value="${user.telefono}"></td>
//                    <td><button type="sumbit" class="form-submit-btn">Editar</button></td>
//                </form>
//            `;
//            tbody.appendChild(row);
//        });
